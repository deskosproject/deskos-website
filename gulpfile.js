...
gulp.task('scripts', function() {
  return gulp.src(['./src/scripts/*.js','./node_modules/jquery/dist/jquery.min.js','./node_modules/jquery-smooth-scroll/jquery.smooth-scroll.min.js'])
  .pipe(gulp.dest('./dist'))
  .pipe(browserSync.stream());
})
...
gulp.task('styles', function() {
  return gulp.src(['./src/styles/main.scss','./node_modules/bootstrap/dist/css/bootstrap.min.css','./node_modules/font-awesome/css/font-awesome.min.css'])
  .pipe(sass())
